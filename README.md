...
Телеграм-бот на PyTelegramBotAPI, который принимает ссылки на YouTube, Instagram или VK Видео, предлагает варианты качества и скачивает видео вместе с описанием. YouTube — основной приоритет, но поддерживаются и Instagram/VK ссылки.
